// Temporarily hidden — Member Directory component preserved for future use.
...
// Dummy export to keep the module valid
export function MemberDirectory(_props: { directoryUrl?: string }) { return null; }
