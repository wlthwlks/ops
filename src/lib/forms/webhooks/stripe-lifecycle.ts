  ...
  switch (event.type) {
    ...
    case "customer.subscription.updated": {
      ...
      if (scheduledCancel) {
        ...
        // status — reacting to that re-marked members as Paid/Active and
        // extended Service access until without payment. Payment evidence is
        // owned by invoice.paid (always-on) and trusted confirm-checkout.
